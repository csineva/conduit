...
class TestRegistration(object):
    ...
    def check_registration_data_in_db(self, user, email, password):
        id_db, username_db, pass_hashed_db, email_db, *_ = self.query_db(
    ...
    def test_fill(self):
        for data in test_data:
            ...
            if not data['user']:
                ...
                self.check_registration_data_in_db(data['user'], data['email'], data['password'])
